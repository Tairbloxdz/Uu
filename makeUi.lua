...
local RayfieldFolder = "Taidepzai hub"
local ConfigurationFolder = RayfieldFolder.."/Configurations"
local ConfigurationExtension = ".rfld"
local settingsTable = {
	General = {
		-- if needs be in order just make getSetting(name)
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'set keyw'},
		-- buildwarnings
		-- rayfieldprompts

	},
	System = {
		usageAnalytics = {Type = 'toggle', Value = true, Name = 'hub beta'},
	}
}
		...
		if useStudio then
			...
			task.spawn(function()
				...
				if success and reporter then
					...
					warn("Failed to load or execute the reporter. \nPlease notify in https://discord.gg/TFmhmbGjEE ")
				end
			end)
...
local Rayfield = useStudio and script.Parent:FindFirstChild('Taidepzai') or game:GetObjects("rbxassetid://10804731440")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Taidepzai') or game:GetObjects("rbxassetid://10804731440")[1]
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Open menu'.", Duration = 7, Image = 4400697855})
		else
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Skider no1"
	end
